...
public class zombieScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //GetComponent<Animation>().Play("cat_armature|walk");
    }
    ...
    void OnTriggerEnter(Collider col)
    {
        ...
        GameObject cat = Instantiate(Resources.Load("cat", typeof(GameObject))) as GameObject;
        ...
        cat.transform.position = new Vector3(randomX, constantY, randomZ);
        ...
        while (Vector3.Distance(cat.transform.position, Camera.main.transform.position) <= 3)
        {
